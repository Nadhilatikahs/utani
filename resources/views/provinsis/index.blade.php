...
@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('provinsis.create') }}" class="btn btn-primary">Tambah Provinsi</a>
    </div>
    <hr />
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @forelse($provinsis as $rs)
                <tr>
                    <td class="align-middle">{{ $rs->kode_provinsi }}</td>
                    <td class="align-middle">{{ $rs->nama_provinsi }}</td>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center">Data Provinsi belum Tersedia.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
