                ...
                <div class="col-md-12">
                  ...
                  <div class="card">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Grafik Komoditas Usaha Tani (Pendapatan-Seluruh Beban)</h6>
                        </div>
            ...
            ?>
                        <script>
                                            ...
                                            function fetchData(tahun) {
                                              ...
                                              var url3 = "{{url('grafik/viewJmlPenjualanJson')}}";
                                            ...
                                            //   console.log(data);
                                              var categories = data.map(item => item.nama_komoditas);
