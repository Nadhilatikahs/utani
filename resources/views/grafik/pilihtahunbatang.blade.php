                ...
                <div class="col-md-12">
                  ...
                  <div class="card">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Grafik Usaha Tani Bulan Berjalan</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                ...
                                <div>
                                    <select class="form-select" id="pilihan" onchange="myFunction()">

                                            @foreach($daftartahun as $dft)
                                                <option value="{{$dft->tahun}}">{{ $dft->tahun }}</option>
                                            @endforeach
...
<script>
    // fungsi untuk menangkap even on change
    function myFunction() {
    ...
    function fetchData(tahun) {
      ...
      var url3 = "{{url('grafik/viewDataPenjualanSelectOption/')}}";
    ...
    //   console.log(data);
      var categories = data.map(item => item.wkt);
      var values = data.map(item => parseInt(item.total_keuntungan));
      var valuesBebanVariabel = data.map(item => parseInt(item.total_beban_variabel));
      var valuesBebanFix = data.map(item => parseInt(item.total_beban_fix));
    //   console.log(values);
      // Konfigurasi grafik
      var options = {
        series: [
                    ...
                    {
                        name: 'Total Beban Variabel',
                        data: valuesBebanVariabel
                    },
                    {
                        name: 'Total Beban Fix',
                        data: valuesBebanFix
                    }
                ],
        chart: {
          type: 'bar', // Jenis grafik sesuai dengan pilihan,
          height: 350
        },
        plotOptions: {
                    bar: {
        ...
        dataLabels: {
                    ...
                    textAnchor: 'middle', // Posisi teks (start, middle, end)
                    offsetY: -10,
                    style: {
                        fontSize: '10px',
                        colors: ["#304758"]
        ...
        xaxis: {
          categories: categories // Kategori sesuai dengan waktu
        },
        yaxis: {
                    title: {
                        text: 'Informasi Usaha Tani ('+tahun+')'
                    }
                },
        legend: {
          position: 'top',
