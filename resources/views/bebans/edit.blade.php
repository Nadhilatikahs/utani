...
@section('contents')
    <h1 class="mb-0">Data Beban</h1>
    <hr />
    <form action="bebans.update, $bebans->id_beban" method="POST">
        @csrf
        @method('PUT')
        <fieldset disabled>
        ...
        <div class="row mb-3">
        <div class="col">
                <input type="hidden" name="id_beban" class="form-control" placeholder="ID" value="{{$id_beban}}">
            </div>
        
        </div>
        <div class="row mb-3"> 
        <div class="col">Nama Beban
                <input type="text" name="nama_beban" class="form-control" placeholder="" value="{{$nama_beban}}" required>
            </div>
            <div class="col">Kategori Beban
                <label for="kategori"></label>
                <select class="form-control select" style="width:100%;" name="kategori" id="kategori" value="{{$kategori}}">
            ...
            <div class="form-group"> keterangan
                <select class= "form-control select" style ="width:100%;" name="id_kategori" id="id_kategori" value="{{$id_kategori}}">
