...
@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('upts.create') }}" class="btn btn-primary">Tambah Data</a>
    </div>
    <hr />
    ...
    <table class="table table-hover">
        ...
        <tbody>+
                ...
                @forelse($upts as $d)
                    <tr>
                        <td class="align-middle">{{ $d->kode_upt }}</td>
                        <td class="align-middle">{{ $d->nama_upt }}</td>
                        <td class="align-middle">{{ $d->alamat }}</td>
                        <td class="align-middle">{{ $d->nama_dinas }}</td>
                ...
                @empty
                                  <div class="alert alert-danger">
                                      Data Unit Pelaksana Teknis belum Tersedia.
                                  </div>
             @endforelse
        </tbody>
    </table>
