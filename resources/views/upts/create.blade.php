<!-- //resources/views/upts/create.blade.php -->
@extends('layouts.app')
  
@section('title', 'Tambah Data UPT')
...
@section('contents')
    ...
    <hr />
    <form action="{{ route('upts.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <fieldset disabled>
            <div class="mb-3">
                <label for="kodeuptlabel">Kode UPT</label>
                <input class="form-control form-control-solid" id="kode_upt_tampil" name="kode_upt_tampil" type="text" placeholder="Contoh: UPT-001" value="{{$kode_upt}}" readonly>
            </div>
        </fieldset>
        ...
        <div class="row mb-3">
            <div class="col">
                <input type="hidden" name="id_upt" class="form-control" placeholder="ID">
            </div>
        </div>
        
        <div class="row mb-3">
            <div class="col">
                <input type="text" name="nama_upt" class="form-control" placeholder="Nama UPT" pattern="[A-Za-z\s]+" title="Hanya huruf yang diizinkan" required>
                @error('nama_upt')
        ...
        <div class="row mb-3">
            ...
            <div class="form-group">
                <select class="form-control select" style="width:100%;" name="id_dinas" id="id_dinas" required>
...
<script>
    ...
    // Tampilkan marker semua UPT dari database (jika ada)
