...
@section('contents')
    ...
    <hr />
    <form action="{{ route('keltanis.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <fieldset disabled>
        ...
        <div class="row mb-3">
        <div class="col">
                <input type="hidden" name="id_keltani" class="form-control" placeholder="ID">
            </div>
        
        </div>
        <div class="row mb-3">
        <div class="col">
                <input type="text" name="nama_keltani" class="form-control" placeholder="Nama keltani" pattern="[A-Za-z\s]+" title="Hanya huruf yang diizinkan" required>
                @error('nama_keltani')
        ...
        <div class="row">
            <div class="col text-left d-flex gap-2">
                <a href="{{ route('keltanis.index') }}" class="btn btn-secondary">Kembali</a>
