...
@section('contents')
    <h1 class="mb-0">Beban Tanam</h1>
    <hr />
    <form action="{{ route('bebantanam.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row mb-3">
            <div class="col">
                <input type="hidden" name="id_bebantanam" class="form-control" placeholder="ID">
                <div class="row"> 
            ...
            <div class="row mb-3">
                ...
                <div class="col"> jumlah
                    <input type="number" name="jumlah" id="jumlah" class="form-control" placeholder="jumlah" min="0" max="999" required>
                </div>
                <div class="col"> harga
                    <input type="number" name="harga" id="harga" class="form-control" placeholder="harga" min="0" max="999999" required>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            jumlahInput.addEventListener('input', function() {
                ...
                if (value.length > 3) {
                    jumlahInput.value = value.slice(0, 3);
                }
            });
